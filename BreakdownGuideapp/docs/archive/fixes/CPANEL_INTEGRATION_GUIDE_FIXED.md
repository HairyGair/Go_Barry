...
PRODUCTION_URL=https://go-barry.onrender.com

# ============= CORS CONFIGURATION =============
# FIXED: Multiple origins support
CORS_ENABLED=true
ALLOWED_ORIGINS=https://gobarry.co.uk,https://www.gobarry.co.uk,https://go-barry.onrender.com,http://localhost:3000,http://localhost:8081
...
function getAllowedOrigins() {
  ...
  const regexOrigins = [
    ...
    /^https:\/\/.*\.onrender\.com$/,        // Any Render.com subdomain
    /^https:\/\/.*\.render\.com$/,          // Any Render.com domain
...
- **Render (Development)**: https://go-barry.onrender.com
