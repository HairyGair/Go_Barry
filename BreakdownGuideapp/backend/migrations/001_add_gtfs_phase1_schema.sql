-- ═══════════════════════════════════════════════════════════════════════════════
-- GTFS Phase 1 Database Migration
-- Purpose: Add route_id column and create necessary views/tables for Phase 1
-- Date: November 11, 2025
--
-- Usage: Execute this SQL file in your MySQL client (phpMyAdmin, MySQL Workbench, etc.)
-- ═══════════════════════════════════════════════════════════════════════════════

-- Step 1: Add route_id column to breakdowns table
ALTER TABLE breakdowns
ADD COLUMN route_id VARCHAR(10) NULL COMMENT 'GTFS route_id for matching to transit routes' AFTER fleet_no;
