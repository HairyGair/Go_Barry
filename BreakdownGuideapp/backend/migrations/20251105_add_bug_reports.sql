...
CREATE TABLE IF NOT EXISTS bug_reports (
  ...
  FOREIGN KEY (reporter_id) REFERENCES supervisors(id) ON DELETE SET NULL,
  FOREIGN KEY (resolved_by) REFERENCES supervisors(id) ON DELETE SET NULL
...
CREATE TABLE IF NOT EXISTS bug_report_comments (
  ...
  FOREIGN KEY (user_id) REFERENCES supervisors(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
