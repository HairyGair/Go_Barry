                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300 mt-1">
                      Record this incident in the Tranzaura System (EP Morris code) when the bus is stationary and in a safe location
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-blue-500/20 rounded-lg p-4 border border-blue-400/30">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-blue-200">Tranzaura System Reminder</h4>
                  <p className="text-sm text-gray-300 mt-1">
                    Record this incident immediately in the Tranzaura System (EP Morris code) with all diagnostic information
                  </p>
                </div>
              </div>
            </div>
