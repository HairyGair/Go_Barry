                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('hours_of_darkness', 'no'); onNext(); }}
                            ...
                            <button
                                onClick={() => { updateResponse('hours_of_darkness', 'yes'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                ...
                <div className="space-y-6">
                    ...
                    {responses.vehicle_type === 'single_deck' ? (
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                            ...
                            <div className="space-y-3">
                                <button
                                    onClick={() => { updateResponse('fifty_percent_met', 'yes'); onNext(); }}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => { updateResponse('fifty_percent_met', 'no'); onNext(); }}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                                ...
                                <div className="space-y-3">
                                    <button
                                        onClick={() => { updateResponse('lower_deck_fifty', 'yes'); onNext(); }}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <button
                                        onClick={() => { updateResponse('lower_deck_fifty', 'no'); onNext(); }}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                                ...
                                <div className="space-y-3">
                                    <button
                                        onClick={() => { updateResponse('upper_deck_fifty', 'yes'); onNext(); }}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <button
                                        onClick={() => { updateResponse('upper_deck_fifty', 'no'); onNext(); }}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('step_light_working', 'yes'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('step_light_working', 'no'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <div className="text-green-300/90 space-y-2">
                                        ...
                                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 mt-4">
                                            ...
                                            <ul className="list-disc list-inside space-y-1 text-green-300/90 text-sm">
                                                <li>Record lighting defects in their reporting device</li>
