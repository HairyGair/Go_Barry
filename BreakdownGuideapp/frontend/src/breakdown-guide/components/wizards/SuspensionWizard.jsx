...
const SuspensionWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete }) => {
    ...
    const { AlertTriangle, ArrowLeft, ArrowRight, Home, CheckCircle, XCircle, FileText, Shield, AlertCircle, Tool } = Icons;
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('reset_result', 'cleared'); onNext(); }}
                            ...
                            <button
                                onClick={() => { updateResponse('reset_result', 'persists'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('reset_result', 'unable'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('warning_lights', 'red'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('warning_lights', 'amber'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('warning_lights', 'none'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('warning_lights', 'unsure'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('vehicle_lean', 'yes'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('vehicle_lean', 'no'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('vehicle_lean', 'unsure'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('audible_bang', 'yes'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('audible_bang', 'no'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('audible_bang', 'unsure'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('air_pressure', 'normal'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('air_pressure', 'low'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('air_pressure', 'failing'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('air_pressure', 'unsure'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('ride_quality', 'acceptable'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('ride_quality', 'hard'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('ride_quality', 'soft'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('ride_quality', 'unstable'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
...
export default SuspensionWizard;
