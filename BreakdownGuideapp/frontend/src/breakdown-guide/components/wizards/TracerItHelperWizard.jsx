...
const TracerItHelperWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete, onWizardSelect }) => {
    ...
    const { AlertTriangle, ArrowLeft, ArrowRight, Home, CheckCircle, XCircle, FileText, Shield, AlertCircle, Phone, Users, Tool, Info } = Icons;
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('driver_injury_status', 'no_injury'); onNext(); }}
                            ...
                            <button
                                onClick={() => { updateResponse('driver_injury_status', 'injured'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-6 border border-blue-400/30">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('no_injured_passengers', true); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
...
export default TracerItHelperWizard;
