...
const DestinationDisplayWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete }) => {
    ...
    const { AlertTriangle, ArrowLeft, ArrowRight, Home, CheckCircle, XCircle, FileText, Shield, AlertCircle, Info } = Icons;
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('affected_display', 'front'); onNext(); }}
                            ...
                            <button
                                onClick={() => { updateResponse('affected_display', 'other'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('affected_display', 'front_and_others'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => { updateResponse('fault_type', 'blank'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('fault_type', 'wrong_info'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('fault_type', 'partial'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => { updateResponse('fault_type', 'stuck'); onNext(); }}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-yellow-500/20 backdrop-blur-sm rounded-lg p-6 border border-yellow-400/30">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-yellow-300/90 text-sm">
                            <li>Front display issues cause most passenger confusion - prioritise clear announcements</li>
...
export default DestinationDisplayWizard;
