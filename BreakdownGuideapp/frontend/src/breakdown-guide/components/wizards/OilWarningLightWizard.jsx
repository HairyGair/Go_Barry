    ...
    switch (currentStep) {
            ...
            return (
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-300">Critical engine protection system evaluation following SDC Engineering Issues Guide (Page 22) - immediate action required.</p>
                    </div>
                    ...
                    <div className="bg-red-500/30 backdrop-blur-sm rounded-lg p-6 border border-red-400/50">
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                            <h4 className="font-semibold text-red-200 mb-2">SDC Guide Protocol - Step 1:</h4>
                    ...
                    <div className="bg-orange-500/20 backdrop-blur-sm rounded-lg p-6 border border-orange-400/30">
                        <h3 className="text-lg font-semibold text-orange-200 mb-4">⚡ IMMEDIATE ACTION REQUIRED - SDC PROCEDURE</h3>
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                            <p className="text-orange-300/90 font-semibold mb-2">
                                Per SDC Guide - Step 1: Instruct the Driver to Stop Immediately:
                            </p>
                    ...
                    {canInspect ? (
                        <div className="space-y-6">
                            <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-6 border border-blue-400/30">
                                <h3 className="text-lg font-bold text-blue-200 mb-4">📋 SDC Guide - Step 2: Check for Oil Leaks</h3>
                                ...
                                <div className="bg-red-500/30 backdrop-blur-sm rounded-lg p-6 border border-red-400/50">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-red-300/90 space-y-2">
                                            <p className="font-semibold">Per SDC Guide - Vehicle must remain STOPPED:</p>
                                            <ul className="list-disc list-inside space-y-1 text-red-300/90 text-sm">
        ...
        case 3:
            ...
            return (
                <div className="space-y-6">
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-white mb-2">💡 SDC Guide - Step 3: Light Status While Moving</h2>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-red-300/90 space-y-2">
                                        ...
                                        <ul className="list-disc list-inside space-y-1 text-red-300/90 text-sm">
                                            <li>Per SDC Guide: STOP immediately and seek assistance from engineering</li>
        ...
        case 4:
            ...
            // Per SDC Guide page 22 - any oil light on or intermittent while moving = STOP
            ...
            return (
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-300">Complete assessment following SDC Guide and DVSA defect categorisation standards.</p>
                    </div>
                        ...
                        <div className="bg-red-500/30 backdrop-blur-sm rounded-lg p-6 border border-red-400/50">
                            <div className="text-center">
                                ...
                                <p className="text-red-300/90 text-sm mb-6">
                                    Per SDC Guide: Vehicle must remain stopped with engine OFF - Await engineering assistance
                                </p>
                            </div>
                            
                            <div className="text-left">
                                <div className="bg-white/10 backdrop-blur-sm rounded p-4">
                                    <h4 className="font-semibold text-red-200 mb-3">SDC Guide Mandatory Actions:</h4>
                                ...
                                {hasLeak && (
                                    <div className="bg-red-400/20 backdrop-blur-sm rounded p-4 mt-4">
                                        <p className="font-semibold text-red-200 mb-2">⚠️ Fire or Hazard Risk (per SDC Guide):</p>
                        ...
                        <div className="bg-amber-500/20 backdrop-blur-sm rounded-lg p-6 border border-amber-400/30">
                            <div className="text-center">
                                ...
                                <p className="text-amber-300/90 text-sm mb-6">
                                    Oil light only at idle - not currently covered by SDC Guide Step 3 criteria
                                </p>
                            </div>
                            ...
                            <div className="text-left">
                                <div className="bg-white/10 backdrop-blur-sm rounded p-4">
                                    ...
                                    <ol className="list-decimal ml-6 space-y-2 text-amber-300/90 text-sm">
                                        ...
                                        <li>Monitor for any change that triggers SDC Step 3 criteria</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <ul className="list-disc ml-6 space-y-1 text-blue-300/80 text-sm">
                                    ...
                                    <li>Include all SDC Guide step outcomes</li>
                    ...
                    <div className="bg-purple-500/20 backdrop-blur-sm rounded-lg p-6 border border-purple-400/30">
                        <h4 className="font-semibold text-purple-200 mb-2">🔔 SDC Guide Policy & DVSA Compliance</h4>
                        <p className="text-purple-300/80 text-sm mb-3">
                            Safety First: Stop immediately if any doubt exists. Per SDC Guide, oil warning lights require immediate stop and engineering assistance. 
                        ...
                        <div className="bg-white/10 rounded p-3">
                            ...
                            <ul className="list-disc ml-6 text-purple-300/80 text-xs space-y-1">
                                <li>SDC Guide to Engineering Issues v1.3 - Page 22</li>
