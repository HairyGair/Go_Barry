              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Unusual noises (e.g., grinding or squealing) during braking</span>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Visible leaks in the brake system (e.g., brake fluid)</span>
                  </div>
                </button>
            ...
            {hasCriticalIssue ? (
              <div className="bg-red-500/20 backdrop-blur-sm rounded-lg p-6 border border-red-400/30">
                ...
                <div className="space-y-4 text-red-300/90">
                  ...
                  <div>
                    <p className="mb-2">Immediate Actions:</p>
                    <ol className="list-decimal ml-6 space-y-2 text-sm">
                      ...
                      <li>Record defects immediately on the Tranzaura System when the bus is stationary</li>
                    </ol>
                  </div>
                </div>
              </div>
