...
const DisplayScreen = () => {
  ...
  // FIXED: Use Convex hooks for real-time supervisor sync
  const { activeSupervisors, useSupervisorActions } = useConvexSync();
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            ...
            <p style={{
              ...
              Control Room • Live Operations • Convex Real-time
            </p>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            Go BARRY v3.0 • Control Room Operations • Convex Sync Active
          </div>
        </div>
      </div>
    </div>
