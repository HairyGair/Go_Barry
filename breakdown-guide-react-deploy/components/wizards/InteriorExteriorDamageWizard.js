...
const InteriorExteriorDamageWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete }) => {
    ...
    const { AlertTriangle, ArrowLeft, ArrowRight, Home, CheckCircle, XCircle, FileText, Shield, AlertCircle, Eye, Car, Wrench } = window.Icons;
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('damage_type', 'floor_driver_area')}
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'driver_seat')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'rear_view_mirror')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'horn')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'passenger_seats')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'body_panels')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'interior_panels')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'bumper_bar')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'registration_plate')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('affects_control', 'yes')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('affects_control', 'no')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('detachment_risk', 'high')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('detachment_risk', 'injury')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('detachment_risk', 'low')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('detachment_risk', 'none')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('can_secure', 'yes')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('can_secure', 'no')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('can_secure', 'not_applicable')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
