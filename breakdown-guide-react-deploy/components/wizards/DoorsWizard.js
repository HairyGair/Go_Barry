          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                <button
                  onClick={() => updateResponse('initialChecks', 'buttons_stuck')}
                ...
                <button
                  onClick={() => updateResponse('initialChecks', 'obstructions')}
                  className={`p-4 rounded-lg border-2 transition-all ${
                ...
                >
                  <div className="flex items-center space-x-3">
                    {window.Icons.package}
                    <span>Yes - Obstructions found</span>
                  </div>
                </button>
                <button
                  onClick={() => updateResponse('initialChecks', 'clear')}
                  className={`p-4 rounded-lg border-2 transition-all ${
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                <button
                  onClick={() => updateResponse('airSystemCheck', 'air_leaks')}
                  className={`p-4 rounded-lg border-2 transition-all ${
                ...
                <button
                  onClick={() => updateResponse('airSystemCheck', 'low_pressure')}
                  className={`p-4 rounded-lg border-2 transition-all ${
                ...
                <button
                  onClick={() => updateResponse('airSystemCheck', 'pressure_resolved')}
                  className={`p-4 rounded-lg border-2 transition-all ${
                ...
                <button
                  onClick={() => updateResponse('airSystemCheck', 'no_improvement')}
                  className={`p-4 rounded-lg border-2 transition-all ${
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                <button
                  onClick={() => updateResponse('safetyDefects', 'present')}
                  className={`p-4 rounded-lg border-2 transition-all ${
                ...
                <button
                  onClick={() => updateResponse('safetyDefects', 'none')}
                  className={`p-4 rounded-lg border-2 transition-all ${
          ...
          <div className="space-y-6">
            <div className="text-center">
              <div className={`mx-auto w-16 h-16 ${responses.safetyDefects === 'present' ? 'bg-red-500/20' : 'bg-amber-500/20'} rounded-full flex items-center justify-center mb-4`}>
                {responses.safetyDefects === 'present' ? window.Icons.xCircle : window.Icons.alertTriangle}
              </div>
