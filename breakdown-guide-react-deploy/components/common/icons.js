...
const Droplets = ({ className = "w-4 h-4", ...props }) => (
    React.createElement('svg', {
        className,
        fill: "none",
        stroke: "currentColor",
        ...
        strokeLinejoin: "round",
        strokeWidth: 2,
        d: "M7.5 12c0-3.039 2.015-5.625 4.5-6.374C14.485 6.375 16.5 8.961 16.5 12a4.5 4.5 0 01-9 0zM12 21.75c4.56 0 8.25-3.69 8.25-8.25S16.56 5.25 12 5.25s-8.25 3.69-8.25 8.25S7.44 21.75 12 21.75z"
    }))
);

const Eye = ({ className = "w-4 h-4", ...props }) => (
    React.createElement('svg', {
        className,
        fill: "none",
        stroke: "currentColor",
...
const Flame = ({ className = "w-4 h-4", ...props }) => (
    React.createElement('svg', {
        className,
        fill: "none",
        stroke: "currentColor",
        ...
        strokeLinejoin: "round",
        strokeWidth: 2,
        d: "M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 1-4 4-4 1.657 0 3 .5 3.657 2.343A7.975 7.975 0 0117 10c0 3.657-1.343 6.657-3.343 8.657z"
    }))
);

const Users = ({ className = "w-4 h-4", ...props }) => (
    React.createElement('svg', {
        className,
        fill: "none",
        stroke: "currentColor",
