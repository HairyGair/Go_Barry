...
const CuttingOutFuelWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete }) => {
    // Get icons from global scope with fallback
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-red-500/20 backdrop-blur-sm rounded-lg p-6 border border-red-400/30">
                        ...
                        <p className="text-red-300/80 text-sm leading-relaxed mb-4">
                            Fuel system issues pose immediate fire and explosion risks. SDC guidance prioritizes detection of fuel leaks and prevention of ignition sources.
                        </p>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('ignition_status', 'ignition_on')}
                            ...
                            <button
                                onClick={() => updateResponse('ignition_status', 'ignition_off')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('ignition_status', 'ignition_intermittent')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-6 border border-blue-400/30">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('vehicle_status', 'engine_running')}
                            ...
                            <button
                                onClick={() => updateResponse('vehicle_status', 'engine_stopped')}
                                className={`w-full p-3 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('vehicle_status', 'engine_cutting_out')}
                                className={`w-full p-3 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('fuel_leak_status', 'no_leak_detected')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('fuel_leak_status', 'fuel_leak_identified')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('fuel_leak_status', 'unable_to_inspect')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('occurrence_pattern', 'first_time')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('occurrence_pattern', 'persistent_problem')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('occurrence_pattern', 'worsening_condition')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('occurrence_pattern', 'unknown_history')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    {(responses.occurrence_pattern === 'persistent_problem' || responses.occurrence_pattern === 'worsening_condition') && (
                        <div className="bg-orange-500/20 backdrop-blur-sm rounded-lg p-6 border border-orange-400/30">
                            ...
                            <div className="space-y-3">
                                <button
                                    onClick={() => updateResponse('current_cutting_status', 'no_further_issues')}
                                    className={`w-full p-3 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('current_cutting_status', 'continued_cutting_out')}
                                    className={`w-full p-3 rounded-lg border-2 transition-all text-left ${
