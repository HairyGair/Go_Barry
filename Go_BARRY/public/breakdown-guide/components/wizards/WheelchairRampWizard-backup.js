// Wheelchair Lift/Ramp Wizard Component
    ...
    switch (currentStep) {
        case 1:
            return (
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-2">♿ Wheelchair Ramp/Lift Assessment</h2>
                    ...
                    <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-6">
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-blue-700">Wheelchair accessibility systems are legally required under the Equality Act. A defective system requires immediate attention to ensure compliance.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                            ...
                            <p className="text-red-700 text-sm mb-4">Select the primary problem with the accessibility system.</p>
                            <div className="space-y-3">
                                ...
                                <label className="flex items-start p-4 border rounded-lg hover:bg-gray-50 cursor-pointer">
                                    ...
                                    />
                                    <div>
                                        <span className="font-medium text-orange-600">❌ Ramp/lift won't deploy</span>
                                        <p className="text-sm text-gray-600 mt-1">Cannot extend ramp/lift from stowed position</p>
                                    </div>
                                </label>
                                <label className="flex items-start p-4 border rounded-lg hover:bg-gray-50 cursor-pointer">
                                    <input
                                        ...
                                        <div className="text-red-700 space-y-2">
                                            ...
                                            <div className="bg-white rounded p-4 mt-4">
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-red-700">
                                                    <li>Cannot refuse wheelchair user due to equipment defect</li>
                                                    <li>Must provide accessibility or arrange immediate alternative</li>
                                                    <li>Contact engineering immediately if system not functional</li>
        ...
        case 2:
            ...
            if (responses.issue_type === 'ramp_stuck_out') {
                ...
                return (
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        <div className="mb-6">
                            <h2 className="text-xl font-semibold text-gray-900 mb-2">🔧 System Operation Test</h2>
                            <p className="text-gray-600">Test the wheelchair accessibility system through its operational cycle.</p>
                        </div>
                        ...
                        <div className="space-y-6">
                            {/* Similar testing sections as original but streamlined */}
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <h3 className="font-semibold text-blue-900 mb-3">System Functionality Test</h3>
                                <p className="text-blue-700 text-sm mb-4">Test the complete operation cycle.</p>
                                <div className="space-y-3">
                                    <label className="flex items-start p-4 border rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input
                                            type="radio"
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 mt-1">All functions working correctly</p>
                                        </div>
                                    </label>
                                    <label className="flex items-start p-4 border rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 mt-1">Some issues but still useable</p>
                                        </div>
                                    </label>
                                    <label className="flex items-start p-4 border rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 mt-1">System failure - cannot provide access</p>
                                        </div>
                                    </label>
                                </div>
                            </div>
        ...
        case 3:
            ...
            return (
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold text-gray-900 mb-2">📋 Wheelchair Access System Decision</h2>
                                            ...
                                            <div className="bg-white rounded p-4 mt-4">
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-red-700">
                                                    ...
                                                    {responses.functionality === 'not_functional' && 
                                                        <li>Accessibility system completely non-functional</li>}
                                                </ul>
                                            ...
                                            <div className="bg-white rounded p-4 mt-4">
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-green-700">
                                                    {responses.reset_result === 'resolved' && 
                                                        <li>Vehicle reset successfully cleared the issue</li>}
                                                    {responses.manual_attempt === 'successful' && 
                                                        <li>Manual retraction completed successfully</li>}
                                                    {responses.functionality === 'fully_operational' && 
                                                        <li>System tested and fully operational</li>}
                                                </ul>
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-green-700">
                                                    ...
                                                    <li>Monitor system for any recurrence</li>
                                            ...
                                            <div className="bg-white rounded p-4 mt-4">
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-yellow-700">
                                                    {responses.functionality === 'partial_function' && 
                                                        <li>System partially functional - may deteriorate</li>}
                                                    <li>Accessibility system requires engineering attention</li>
                                                </ul>
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-yellow-700">
                                                    ...
                                                    <li>If wheelchair user boards, test system first</li>
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-blue-700">All wheelchair accessibility defects must be recorded in the Go-Check system immediately, including:</p>
                                    <ul className="list-disc list-inside mt-2 text-blue-700">
                                        <li>Nature of the defect</li>
                                        <li>Actions taken (reset attempts, manual intervention)</li>
                                        <li>Current status of the system</li>
