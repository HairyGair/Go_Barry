...
const App = function() {
    ...
    useEffect(() => {
        ...
        if (window.SupervisorBreakdownLogger) {
            ...
            console.log('✅ SupervisorBreakdownLogger initialised');
        }
        ...
        if (window.BreakdownAnalytics) {
            ...
            console.log('✅ BreakdownAnalytics initialised');
        }
        ...
        if (window.breakdownTracker) {
            ...
            console.log('✅ BreakdownTracker initialised');
        }
        
        console.log(`✅ NO AUTH MODE: All systems initialised for ${supervisorSession.name}`);
    }, []);
