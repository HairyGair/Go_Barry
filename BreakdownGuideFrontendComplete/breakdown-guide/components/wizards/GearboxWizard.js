                    ...
                    <div className="space-y-6">
                        <div className="bg-amber-900/20 border border-amber-500/30 rounded-lg p-4">
                            <div className="flex items-start space-x-3">
                                <div className="text-amber-400 mt-1">{window.Icons.AlertTriangle}</div>
                                <div>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-white font-semibold flex items-center space-x-2">
                                <span className="text-blue-400">{window.Icons.RotateCcw}</span>
                            ...
                            {responses.resetResult === 'cleared' && (
                                <div className="bg-green-900/30 border border-green-500/50 rounded-lg p-4">
                                    <div className="flex items-start space-x-3">
                                        <div className="text-green-400 mt-1">{window.Icons.CheckCircle}</div>
                                        <div>
                ...
                return (
                    <div className="space-y-6">
                        <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
                            <div className="flex items-start space-x-3">
                                <div className="text-red-400 mt-1">{window.Icons.Droplet}</div>
                                <div>
                        ...
                        <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
                            <div className="flex items-start space-x-3">
                                <div className="text-red-400 mt-1">{window.Icons.AlertTriangle}</div>
                                <div>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-white font-semibold flex items-center space-x-2">
                                <span className="text-blue-400">{window.Icons.Search}</span>
                            ...
                            {(responses.coolantLeaks === 'yes' || responses.coolantLeaks === 'unsure') && (
                                <div className="bg-red-900/30 border border-red-500/50 rounded-lg p-4">
                                    <div className="flex items-start space-x-3">
                                        <div className="text-red-400 mt-1">{window.Icons.StopCircle}</div>
                                        <div>
            ...
            case 3:
                ...
                return (
                    <div className="space-y-6">
                        <div className="bg-amber-900/20 border border-amber-500/30 rounded-lg p-4">
                            <div className="flex items-start space-x-3">
                                <div className="text-amber-400 mt-1">{window.Icons.Mountain}</div>
                                <div>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-white font-semibold flex items-center space-x-2">
                                <span className="text-blue-400">{window.Icons.Route}</span>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                    <h4 className="text-blue-400 font-semibold mb-3 flex items-center space-x-2">
                        <span>{window.Icons.FileText}</span>
                        <span>Required Actions</span>
                    </h4>
                    <div className="space-y-2">
                        <div className="flex items-start space-x-2">
                            <span className="text-blue-400 mt-1">{window.Icons.Check}</span>
                            <span className="text-blue-100 text-sm">Record defect immediately on Go-Check system when stationary and safe</span>
                        </div>
                        <div className="flex items-start space-x-2">
                            <span className="text-blue-400 mt-1">{window.Icons.Check}</span>
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="mb-8">
                <div className="flex items-center space-x-3 mb-4">
                    <div className="w-10 h-10 bg-amber-500 rounded-lg flex items-center justify-center">
                        <span className="text-white text-xl">{window.Icons.Cog}</span>
                    </div>
                    <div>
            ...
            <div className="flex justify-between pt-8">
                ...
                >
                    <span>{window.Icons.ArrowLeft}</span>
                    <span>Previous</span>
                </button>
                ...
                {currentStep === getMaxSteps() ? (
                    ...
                    >
                        <span>Next</span>
                        <span>{window.Icons.ArrowRight}</span>
                    </button>
                )}
            </div>
        </div>
