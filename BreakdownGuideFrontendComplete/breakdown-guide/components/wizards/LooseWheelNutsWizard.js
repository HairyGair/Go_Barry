...
// Follows SDC Engineering Issues Guide - Loose Wheel Nuts Section (Page 28)
            ...
            return (
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-300 text-lg">Immediate safety protocol for wheel nut security failure - following SDC Engineering Issues Guide critical safety procedures.</p>
                    </div>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-red-200/90 space-y-4 text-lg">
                                    ...
                                    <div className="bg-red-600/60 backdrop-blur-sm rounded-lg p-6 mt-6">
                                        <h4 className="font-bold text-2xl text-red-100 mb-4">SDC MANDATORY ACTIONS - NO EXCEPTIONS:</h4>
                                        <ul className="list-disc list-inside space-y-3 text-red-200/90 text-lg">
                                            <li className="font-semibold">🛑 STOP IMMEDIATELY - Do not drive one more meter</li>
                                            <li className="font-semibold">🔒 SWITCH OFF ENGINE - Prevent any movement</li>
                                            <li className="font-semibold">👥 EVACUATE ALL PASSENGERS - Immediate safety priority</li>
                                            <li className="font-semibold">🔧 AWAIT ENGINEERING - Vehicle must not move</li>
                                            <li className="font-semibold">📞 REPORT TO MANAGEMENT - Critical incident protocol</li>
                                        </ul>
                                    </div>
                                    <p className="font-bold text-2xl mt-6 text-red-100">Wheel detachment can cause fatal accidents - zero tolerance policy</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-orange-500/20 backdrop-blur-sm rounded-lg p-6 border border-orange-400/30">
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    onClick={() => updateResponse('discovery_method', 'unusual_noise')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('discovery_method', 'wheel_wobble')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('discovery_method', 'maintenance_check')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                        ...
                        <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-6 border border-blue-400/30">
                            ...
                            <div className="space-y-3">
                                <button
                                    onClick={() => updateResponse('wheel_location', 'front_wheel')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('wheel_location', 'rear_wheel')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('wheel_location', 'multiple_wheels')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('wheel_location', 'unknown_location')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                        ...
                        <div className="bg-yellow-500/20 backdrop-blur-sm rounded-lg p-6 border border-yellow-400/30">
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    onClick={() => updateResponse('vehicle_status', 'moving_unsafe')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <div className="text-red-200/90 space-y-4">
                                        ...
                                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 mt-6">
                                            ...
                                            <div className="mt-6 p-4 bg-red-600/40 backdrop-blur-sm rounded">
                                                <p className="font-bold text-red-100 text-lg">🚫 ZERO TOLERANCE: Vehicle must NOT continue under any circumstances</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-purple-500/20 backdrop-blur-sm rounded-lg p-6 border border-purple-400/30">
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/10 backdrop-blur-sm rounded p-4">
                                <h4 className="font-semibold text-purple-200 mb-3">SDC requires immediate notification to ALL of:</h4>
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/10 backdrop-blur-sm rounded p-4">
                                ...
                                <ul className="list-disc list-inside space-y-1 text-green-300/90 text-sm">
                                    <li>Log incident in Go-Check as CRITICAL SAFETY INCIDENT</li>
                    ...
                    <div className="bg-red-500/20 backdrop-blur-sm rounded-lg p-6 border border-red-400/30">
                        <h3 className="text-lg font-bold text-red-200 mb-3">🚫 Zero Tolerance Policy</h3>
                        <p className="text-red-300/90 text-sm">
                            Loose wheel nuts represent the highest level of safety risk. This incident will trigger a comprehensive fleet inspection and may result in operational changes to prevent recurrence.
                        </p>
                    </div>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-green-300/90">✅ Incident documented in Go-Check</p>
                    ...
                    <div className="bg-red-500/20 backdrop-blur-sm rounded-lg p-6 border border-red-400/30">
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded p-4">
                            <p className="text-red-300/90 text-sm font-semibold mb-2">
                                This vehicle is now PROHIBITED from service under SDC Zero Tolerance Policy:
                            </p>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-green-300/90 mt-2">
                                    All SDC mandatory protocols completed. Vehicle secured and prohibited from service until professional certification. 
                                    Public and passenger safety maintained through immediate emergency response.
                                </p>
                            </div>
                        </div>
                    </div>
