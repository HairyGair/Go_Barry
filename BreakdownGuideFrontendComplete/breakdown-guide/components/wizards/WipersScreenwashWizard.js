...
const WipersScreenwashWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete }) => {
    ...
    const { AlertTriangle, ArrowLeft, ArrowRight, Home, CheckCircle, XCircle, FileText, Shield, AlertCircle, Wind, Tool } = window.Icons;
                            ...
                            <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-6">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-blue-200 font-medium">Record Defect in Go-Check System</p>
