                    ...
                    <div className="space-y-6 pb-32" {...swipeHandlers}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <MobileTouchButton
                                    onClick={() => updateResponse('initial_concern', 'warning_lights')}
                ...
                return (
                    <div className="space-y-6 pb-32" {...swipeHandlers}>
                        ...
                        <div className="space-y-4">
                            ...
                            <MobileTouchButton
                                onClick={() => updateResponse('driver_informed_stop', !responses.driver_informed_stop)}
                            ...
                            <MobileTouchButton
                                onClick={() => updateResponse('passengers_informed', !responses.passengers_informed)}
