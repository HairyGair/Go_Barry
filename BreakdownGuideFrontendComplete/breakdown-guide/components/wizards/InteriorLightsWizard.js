                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('operating_conditions', 'daylight_hours')}
                            ...
                            <button
                                onClick={() => updateResponse('operating_conditions', 'approaching_darkness')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('operating_conditions', 'hours_of_darkness')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('operating_conditions', 'poor_visibility')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                ...
                <div className="space-y-6">
                    ...
                    {responses.vehicle_type === 'single_deck' ? (
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                            ...
                            <div className="space-y-3">
                                <button
                                    onClick={() => updateResponse('deck_lighting', 'more_than_50_percent')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('deck_lighting', 'exactly_50_percent')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('deck_lighting', 'less_than_50_percent')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                                ...
                                <div className="space-y-3">
                                    <button
                                        onClick={() => updateResponse('lower_deck_lighting', 'more_than_50_percent')}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <button
                                        onClick={() => updateResponse('lower_deck_lighting', 'exactly_50_percent')}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <button
                                        onClick={() => updateResponse('lower_deck_lighting', 'less_than_50_percent')}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                                ...
                                <div className="space-y-3">
                                    <button
                                        onClick={() => updateResponse('upper_deck_lighting', 'more_than_50_percent')}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <button
                                        onClick={() => updateResponse('upper_deck_lighting', 'exactly_50_percent')}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    ...
                                    <button
                                        onClick={() => updateResponse('upper_deck_lighting', 'less_than_50_percent')}
                                        className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('step_light_function', 'working_correctly')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('step_light_function', 'not_working')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('step_light_function', 'intermittent')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('step_light_function', 'no_step_light')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
