                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-orange-500/20 backdrop-blur-sm rounded-lg p-6 border border-orange-400/30">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('damage_type', 'glass_only')}
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'glass_and_arm')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('damage_type', 'completely_missing')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-6 border border-blue-400/30">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('vehicle_side', 'nearside')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('vehicle_side', 'offside')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('vehicle_side', 'both_sides')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-yellow-500/20 backdrop-blur-sm rounded-lg p-6 border border-yellow-400/30">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('additional_damage', 'none')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('additional_damage', 'minor_cosmetic')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('additional_damage', 'safety_affecting')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-orange-500/20 backdrop-blur-sm rounded-lg p-6 border border-orange-400/30">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('driver_capability', 'satisfactory')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('driver_capability', 'cannot_use')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
