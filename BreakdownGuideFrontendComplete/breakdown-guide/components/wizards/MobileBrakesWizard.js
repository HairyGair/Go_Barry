...
const MobileBrakesWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete }) => {
    ...
    const { AlertTriangle, Shield, CheckCircle, XCircle } = window.Icons;
                    ...
                    <div className="space-y-6 pb-32" {...swipeHandlers}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <MobileTouchButton
                                    onClick={() => updateResponse('grabbingShuddering', !responses.grabbingShuddering)}
                                ...
                                <MobileTouchButton
                                    onClick={() => updateResponse('noIssues', !responses.noIssues)}
                ...
                return (
                    <div className="space-y-6 pb-32" {...swipeHandlers}>
                        ...
                        <div className="space-y-4">
                            ...
                            <MobileTouchButton
                                onClick={() => updateResponse('logged_in_gocheck', !responses.logged_in_gocheck)}
