            ...
            return (
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <h2 className="text-2xl font-bold text-white mb-2">🛞 PUNCTURE - CRITICAL TIRE SAFETY</h2>
                        <p className="text-gray-300">Immediate tire safety assessment and engineering consultation protocol - following SDC Engineering Issues Guide puncture procedures.</p>
                    </div>
                    
                    <div className="bg-red-500/30 backdrop-blur-sm rounded-lg p-6 border border-red-400/50">
                        <h3 className="text-lg font-semibold text-red-200 mb-4">⚠️ CRITICAL TIRE SAFETY ISSUE</h3>
                        <p className="text-red-300/80 text-sm leading-relaxed mb-4">
                            Punctures compromise vehicle stability and control. Immediate assessment and engineering consultation required for all tire failures.
                        </p>
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-red-300/90 text-sm">
                                ...
                                <li>DETERMINE tire position (front/rear, inner/outer)</li>
                        ...
                        <p className="font-bold text-red-200 mt-4">Tire failure can cause loss of vehicle control</p>
                    </div>
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-300 mt-1">Flat tire or visible damage spotted during checks</p>
                                    </div>
                                </div>
                            </button>
                            <button
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-300 mt-1">Public, police, or DVSA reported tire issue</p>
                                    </div>
                                </div>
                            </button>
                            <button
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-300 mt-1">Sudden tire failure with immediate loss of pressure</p>
                                    </div>
                                </div>
                            </button>
                        </div>
                    ...
                    <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-6 border border-blue-400/30">
                        ...
                        <p className="text-blue-300/80 text-sm mb-4">Determine the position of the punctured tire - critical for safety assessment:</p>
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('tire_position', 'front_nearside')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    responses.tire_position === 'front_nearside'
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        responses.tire_position === 'front_nearside' ? 'border-blue-400 bg-blue-400' : 'border-white/50'
                                    }`}>
                                        {responses.tire_position === 'front_nearside' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                                    </div>
                                    <div>
                            ...
                            <button
                                onClick={() => updateResponse('tire_position', 'front_offside')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    responses.tire_position === 'front_offside'
                                        ? 'border-blue-400 bg-blue-400/20 text-blue-200'
                                        : 'border-white/30 bg-white/10 text-white hover:border-blue-400/50'
                                }`}
                            >
                                <div className="flex items-center space-x-3">
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        responses.tire_position === 'front_offside' ? 'border-blue-400 bg-blue-400' : 'border-white/50'
                                    }`}>
                                        {responses.tire_position === 'front_offside' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                                    </div>
                                    <div>
                            ...
                            <button
                                onClick={() => updateResponse('tire_position', 'rear_nearside_outer')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    responses.tire_position === 'rear_nearside_outer'
                                        ? 'border-blue-400 bg-blue-400/20 text-blue-200'
                                        : 'border-white/30 bg-white/10 text-white hover:border-blue-400/50'
                                }`}
                            >
                                <div className="flex items-center space-x-3">
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        responses.tire_position === 'rear_nearside_outer' ? 'border-blue-400 bg-blue-400' : 'border-white/50'
                                    }`}>
                                        {responses.tire_position === 'rear_nearside_outer' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                                    </div>
                                    <div>
                            ...
                            <button
                                onClick={() => updateResponse('tire_position', 'rear_nearside_inner')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    responses.tire_position === 'rear_nearside_inner'
                                        ? 'border-blue-400 bg-blue-400/20 text-blue-200'
                                        : 'border-white/30 bg-white/10 text-white hover:border-blue-400/50'
                                }`}
                            >
                                <div className="flex items-center space-x-3">
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        responses.tire_position === 'rear_nearside_inner' ? 'border-blue-400 bg-blue-400' : 'border-white/50'
                                    }`}>
                                        {responses.tire_position === 'rear_nearside_inner' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                                    </div>
                                    <div>
                            ...
                            <button
                                onClick={() => updateResponse('tire_position', 'rear_offside_outer')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    responses.tire_position === 'rear_offside_outer'
                                        ? 'border-blue-400 bg-blue-400/20 text-blue-200'
                                        : 'border-white/30 bg-white/10 text-white hover:border-blue-400/50'
                                }`}
                            >
                                <div className="flex items-center space-x-3">
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        responses.tire_position === 'rear_offside_outer' ? 'border-blue-400 bg-blue-400' : 'border-white/50'
                                    }`}>
                                        {responses.tire_position === 'rear_offside_outer' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                                    </div>
                                    <div>
                            ...
                            <button
                                onClick={() => updateResponse('tire_position', 'rear_offside_inner')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    responses.tire_position === 'rear_offside_inner'
                                        ? 'border-blue-400 bg-blue-400/20 text-blue-200'
                                        : 'border-white/30 bg-white/10 text-white hover:border-blue-400/50'
                                }`}
                            >
                                <div className="flex items-center space-x-3">
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        responses.tire_position === 'rear_offside_inner' ? 'border-blue-400 bg-blue-400' : 'border-white/50'
                                    }`}>
                                        {responses.tire_position === 'rear_offside_inner' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                                    </div>
                                    <div>
                            ...
                            <button
                                onClick={() => updateResponse('tire_position', 'unknown_position')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                    responses.tire_position === 'unknown_position'
                                        ? 'border-blue-400 bg-blue-400/20 text-blue-200'
                                        : 'border-white/30 bg-white/10 text-white hover:border-blue-400/50'
                                }`}
                            >
                                <div className="flex items-center space-x-3">
                                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                        responses.tire_position === 'unknown_position' ? 'border-blue-400 bg-blue-400' : 'border-white/50'
                                    }`}>
                                        {responses.tire_position === 'unknown_position' && <div className="w-2 h-2 bg-white rounded-full"></div>}
                                    </div>
                                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <span className="font-medium">🚨 Still moving with compromised tire</span>
                    ...
                    {(responses.tire_position?.includes('front') || responses.discovery_method === 'rapid_deflation' || 
                      responses.vehicle_status === 'moving_compromised') && (
                        <div className="bg-red-500/30 backdrop-blur-sm rounded-lg p-6 border border-red-400/50">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-red-300/90 space-y-2">
                                        ...
                                        <div className="bg-white/10 backdrop-blur-sm rounded p-4 mt-4">
                                            ...
                                            <ul className="list-disc list-inside space-y-1 text-red-300/90 text-sm">
                                                {responses.tire_position?.includes('front') && (
                                                    <li>Front tire puncture affects steering control - stop immediately</li>
                                                )}
                                                {responses.discovery_method === 'rapid_deflation' && (
                                                    <li>Rapid deflation indicates serious tire failure - do not continue</li>
                                                )}
                                                {responses.vehicle_status === 'moving_compromised' && (
                                                    <li>Stop vehicle immediately - compromised tire dangerous at speed</li>
                                                )}
                                    ...
                                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 mt-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                            <div className="space-y-1">
                                                ...
                                                <p className="font-semibold">2. 🎯 DETERMINE tire position</p>
                    ...
                    <div className="flex justify-end pt-6 border-t border-white/20">
                        <button
                            onClick={onNext}
                            disabled={!responses.discovery_method || !responses.tire_position || !responses.vehicle_status}
            ...
            return (
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-300">Mandatory engineering consultation for tire safety evaluation and continuation decision.</p>
                    </div>
                                    ...
                                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="bg-orange-600/20 p-3 rounded">
                                                ...
                                                <p className="text-orange-300/80 text-sm">Contact engineering immediately for tire safety assessment</p>
                                            </div>
                                            <div className="bg-orange-600/20 p-3 rounded">
                                                <h5 className="font-bold text-orange-200 mb-2">2️⃣ LOCATION DETAILS</h5>
                                                <p className="text-orange-300/80 text-sm">Provide exact tire position and puncture details</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="bg-blue-500/20 backdrop-blur-sm rounded-lg p-6 border border-blue-400/30">
                        ...
                        <p className="text-blue-300/80 text-sm mb-4">Confirm engineering has been contacted for tire assessment:</p>
                        <div className="space-y-3">
                            <button
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-300 mt-1">Professional tire assessment arranged</p>
                                    </div>
                                </div>
                            </button>
                            <button
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-300 mt-1">Emergency tire assessment request in progress</p>
                                    </div>
                                </div>
                            </button>
                            <button
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-red-300/90 space-y-2">
                                        ...
                                        {responses.vehicle_safety_status === 'still_moving' && (
                                            <p className="font-semibold bg-white/10 backdrop-blur-sm p-3 rounded">
                                                🛑 STOP VEHICLE IMMEDIATELY - Compromised tire dangerous while moving
                                            </p>
                                        )}
                                    </div>
                                </div>
            ...
            return (
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <p className="text-gray-300">Complete tire safety incident assessment with engineering consultation and SDC compliance.</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                            <div className="space-y-3">
                                ...
                                <div>
                                    ...
                                    <span className="text-white ml-2 capitalize">{responses.tire_position?.replace('_', ' ')}</span>
                                </div>
                                <div>
                    ...
                    <div className="bg-purple-500/20 backdrop-blur-sm rounded-lg p-6 border border-purple-400/30">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-purple-600/20 backdrop-blur-sm rounded-lg p-4">
                                ...
                                <p className="text-purple-300/90 font-semibold">Vehicle must NOT continue in service without explicit engineering approval and tire safety certification.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-1 text-blue-300/80 text-sm">
                                    <li>Document puncture details including tire position</li>
                                    <li>Record engineering consultation and recommendations</li>
                                    <li>Include photos of tire damage if safe to obtain</li>
