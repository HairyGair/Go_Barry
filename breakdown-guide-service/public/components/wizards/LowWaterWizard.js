...
const LowWaterWizard = ({ currentStep, responses, updateResponse, onNext, onPrevious, onComplete }) => {
    ...
    const { AlertTriangle, ArrowLeft, ArrowRight, Home, CheckCircle, XCircle, FileText, Droplets } = window.Icons;
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('leak_check', 'no_leaks')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('leak_check', 'leak_found')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('leak_check', 'uncertain')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    {responses.leak_check === 'leak_found' && (
                        <div className="bg-orange-500/20 backdrop-blur-sm rounded-lg p-6 border border-orange-400/30">
                            ...
                            <div className="space-y-3">
                                <button
                                    onClick={() => updateResponse('leak_severity', 'minor_short_distance')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('leak_severity', 'seek_engineering_advice')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('water_buzzer', 'no_buzzer')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('water_buzzer', 'buzzer_sounding')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('water_buzzer', 'intermittent')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
            ...
            return (
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('recent_topup', 'recently_filled_depot')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('recent_topup', 'filled_long_ago')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('recent_topup', 'driver_unsure')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    {(responses.recent_topup === 'recently_filled_depot' || responses.recent_topup === 'driver_unsure') && (
                        <div className="bg-orange-500/20 backdrop-blur-sm rounded-lg p-6 border border-orange-400/30">
                            ...
                            <div className="space-y-3">
                                <button
                                    onClick={() => updateResponse('topup_feasible', 'topup_arranged')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                                ...
                                <button
                                    onClick={() => updateResponse('topup_feasible', 'topup_not_feasible')}
                                    className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    {decision.priority === 'medium' && (
                        <div className="bg-yellow-500/20 backdrop-blur-sm rounded-lg p-6 border border-yellow-400/30">
                            <div className="flex items-start">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold text-yellow-200 mb-3">⚠️ ARRANGE TOP-UP AND MONITOR</h3>
