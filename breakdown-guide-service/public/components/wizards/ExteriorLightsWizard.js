                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('lighting_conditions', 'daylight')}
                    ...
                    {(responses.lighting_conditions === 'darkness' || responses.lighting_conditions === 'poor_visibility') && (
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                            ...
                            <div className="space-y-3">
                                <button
                                    onClick={() => updateResponse('road_type', 'unrestricted')}
                                ...
                                <button
                                    onClick={() => updateResponse('road_type', 'restricted')}
                                    className={`w-full p-3 rounded-lg border-2 transition-all text-left ${
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                onClick={() => updateResponse('headlights', 'defective')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            <button
                                onClick={() => updateResponse('indicators', 'all_working')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('indicators', 'defective')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                onClick={() => updateResponse('brake_lights', 'both_low_level_failed')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                            ...
                            <button
                                onClick={() => updateResponse('brake_lights', 'constantly_on')}
                                className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
