                    ...
                    <div className="space-y-6">
                        <div className="text-center">
                            <div className="mx-auto w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mb-4">
                                <window.Icons.AlertTriangle className="w-8 h-8 text-red-400" />
                            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        {shouldStop ? (
                            ...
                            <div className="bg-amber-900/30 border border-amber-500/50 rounded-lg p-6">
                                <h3 className="text-amber-400 font-bold text-xl mb-4 flex items-center">
                                    <window.Icons.AlertCircle className="w-6 h-6 mr-2" />
                                ...
                                <div className="space-y-4 text-amber-200">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <ul className="list-disc list-inside space-y-1 ml-4">
                                            ...
                                            <li>Record the defect in Go-Check when safe to do so</li>
                        ...
                        <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                            ...
                            <ul className="text-blue-200 text-sm space-y-1">
                                ...
                                <li>• Always prioritize passenger and public safety</li>
