// Go_BARRY/components/operations/cards/DailyLostMileageImproved.jsx  
...
const DailyLostMileageImproved = ({ onClose }) => {
  ...
  const sharePointUrl = 'https://goaheadgroup.sharepoint.com/:x:/r/sites/GNETS0011/_layouts/15/Doc.aspx?sourcedoc=%7B01D73A9C-5F4C-4688-BB15-54EEC40D1739%7D&file=Daily%20lost%20miles%20report%20-%20SDC.xlsx&action=default&mobileredirect=true&wdsle=0';
  ...
  const handleLoadStart = () => {
    console.log('📊 Loading Daily Lost Mileage document...');
    setIsLoading(true);
    setError(null);
  };

  const handleLoadEnd = () => {
    console.log('📊 Daily Lost Mileage document loaded successfully');
    setIsLoading(false);
    setLastRefresh(new Date());
  };
        ...
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            ...
            <Text style={styles.subtitle}>
              SDC Report • Opened: {lastRefresh.toLocaleTimeString('en-GB', {
                hour: '2-digit',
                minute: '2-digit'
              })}
            </Text>
      ...
      <View style={styles.content}>
        {Platform.OS === 'web' ? (
          <iframe
            ...
            onError={handleError}
            title="Daily Lost Mileage Report - SharePoint Excel"
...
export default DailyLostMileageImproved;